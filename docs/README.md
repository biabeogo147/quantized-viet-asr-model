...
9. [QDC Appium CPU–NPU benchmark](evidence/2026-07-17-qdc-appium-cpu-npu-performance.md) — kết quả Android model-level trên Snapdragon 8 Gen 2, gồm latency, memory, quality và strict HTP placement.
